<?php // content="text/plain; charset=utf-8"
    ...
    // Setup the graph
    $graph = new Graph(300,250); // Permet d'instancier un graphique avec sa taille (largeur, hauteur)
    ...
    $graph->title->Set('Titre du graphique'); // Permet d'ajouter un titre au graphique
    $graph->SetBox(false);
